...
insert into Person (Id, FirstName, LastName, Email, PhoneNumber, BirthDate, ModifiedOn ) 
  values(4, 'David', 'Andrews', 'david.andrews@gmail.com', '456-234-4545', '04/30/1975 2:00:00 PM', getdate())
  
insert into Person (Id, FirstName, LastName, Email, PhoneNumber, BirthDate, ModifiedOn ) 
  values(5, 'Cathy', 'Davis', 'cathy.davis@hotmail.com', '786-232-4765', '07/03/1967 2:00:00 PM', getdate())
